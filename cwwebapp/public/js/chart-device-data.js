  ...
  webSocket.onmessage = function onMessage(message) {
    try {
      ...
      if (existingDeviceData) {
        ...
        newDeviceData.addData(messageData.MessageDate, messageData.IotData.temperature, messageData.IotData.humidity,message.IotData.wind_direction,messageData.IotData.wind_intensity,messageData.IotData.rain);
